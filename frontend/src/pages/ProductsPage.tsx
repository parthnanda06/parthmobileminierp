                ...
                {products.map((product) => {
                  ...
                  return (
                    <tr key={product.id} className="hover:bg-slate-50">
                      ...
                      <td className={`px-6 py-4 whitespace-nowrap text-sm font-medium ${isLowStock ? 'text-red-600' : 'text-slate-900'}`}>{product.currentStock}</td>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <button onClick={() => handleOpenEditModal(product.id)} className="text-slate-600 hover:text-slate-900" title="Edit Product">
