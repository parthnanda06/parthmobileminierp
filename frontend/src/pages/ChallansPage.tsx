              ...
              <tbody className="bg-white divide-y divide-slate-200">
                {challans.map((challan) => (
                  <tr key={challan.id} className="hover:bg-slate-50">
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-bold text-slate-900">{challan.challanNumber}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-slate-700">{challan.customer?.businessName}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-slate-500">{formatDate(challan.createdAt)}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-slate-900 font-medium">{challan.totalQuantity}</td>
