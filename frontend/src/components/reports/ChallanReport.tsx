    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
        <div className="bg-white p-4 rounded-lg border border-slate-200 shadow-sm">
          ...
          <div className="flex items-center">
            ...
            <p className="text-2xl font-bold text-slate-900">{data.summary.totalChallans}</p>
          </div>
        </div>
        <div className="bg-white p-4 rounded-lg border border-slate-200 shadow-sm">
          ...
          <div className="flex items-center">
            ...
            <p className="text-2xl font-bold text-slate-900">{data.summary.confirmedCount}</p>
          </div>
        </div>
        <div className="bg-white p-4 rounded-lg border border-slate-200 shadow-sm">
          ...
          <div className="flex items-center">
            ...
            <p className="text-2xl font-bold text-slate-900">{data.summary.draftCount}</p>
          </div>
        </div>
        <div className="bg-white p-4 rounded-lg border border-slate-200 shadow-sm">
          ...
          <div className="flex items-center">
            ...
            <p className="text-2xl font-bold text-slate-900">{data.summary.cancelledCount}</p>
          </div>
        </div>
        <div className="bg-white p-4 rounded-lg border border-slate-200 shadow-sm">
          ...
          <div className="flex items-center">
            ...
            <p className="text-2xl font-bold text-slate-900">{data.summary.totalQuantity}</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white p-4 rounded-lg border border-slate-200 shadow-sm flex flex-wrap gap-4 items-end">
        ...
        <div>
          ...
          <select value={customerId} onChange={e => setCustomerId(e.target.value)} className="block w-full border border-slate-300 rounded-md py-2 px-3 text-sm max-w-xs">
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-slate-200">
              ...
              <tbody className="bg-white divide-y divide-slate-200">
                {data.data.map((c: any) => (
                  <tr key={c.id}>
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-slate-900">{c.challanNumber}</td>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-slate-900 font-semibold text-right">{c.totalQuantity}</td>
